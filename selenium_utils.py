    ...
    try:
        ...
        try:
            ...
            try:
                ...
                driver.find_element(By.ID, "DisponibilitaSessioneEsameEP_button_value_backFromNew").click()
                ...
                nuovo_candidato_button = driver.find_element(By.ID, "DettaglioDisponibilitaSessioneEsameEP_button_value_newCandidato")
                
                nuovo_candidato_button.click()
                
                # inserisci codice statino nell'input
                disponibilita_sessione_esame_input_codice_statino = driver.find_element(By.ID, "DisponibilitaSessioneEsameEP_disponibilitaSessioneEsameEPView_prenotazioneCandidatoEP_theRichiestaEmissioneDocumentoAbilitazioneEP_codiceFoglioRosa")
                
                disponibilita_sessione_esame_input_codice_statino.send_keys(codice_statino)
                
                # inserisci cognome nell'input
                disponibilita_sessione_esame_input_cognome = driver.find_element(By.ID, "DisponibilitaSessioneEsameEP_disponibilitaSessioneEsameEPView_prenotazioneCandidatoEP_theRichiestaEmissioneDocumentoAbilitazioneEP_thePersonaFisica_descrizioneCognomePersonaFisica")
            
                disponibilita_sessione_esame_input_cognome.send_keys(cognome[0])
                
                # seleziona turno in base all'ora esame
                turno_esaminatore_select_button = Select(driver.find_element(By.ID, "DisponibilitaSessioneEsameEP_disponibilitaSessioneEsameEPView_prenotazioneCandidatoEP_turnoEsaminatore"))
                ...
                conferma_button = driver.find_element(By.ID, "DisponibilitaSessioneEsameEP_button_value_conferma")   
                
                conferma_button.click() 
                
                driver.implicitly_wait(2)
                
                indietro_button = driver.find_element(By.ID, "DisponibilitaSessioneEsameEP_button_value_undoFromDelete")
